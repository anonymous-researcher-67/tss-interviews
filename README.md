# Artifacts for "Beyond the Prank: The Hidden Expertise of TSS Scambaiters"

This repository contains the replication artifacts, qualitative data, and analysis tools for our ACM CCS 2026 Cycle B paper. 

## 📦 Artifact Contents

* **Paper:** [`Beyond the Prank The Hidden Expertise of TSS Scambaiters`](https://arxiv.org/abs/2609.06103) (Pre-print of the accepted manuscript).
* **Interview Template:** [`tss-interviews-template.pdf`](tss-interviews-template.pdf) (The exact questions used during our 17 scam-baiter interviews).
* **Codebook Definition:** [`codebook_definition.xlsx`](codebook_definition.xlsx) (The qualitative coding definitions used to analyze the transcripts).
* **Interactive Results Dashboard:** [`coded_segments.html`](coded_segments.html) (A pre-generated HTML dashboard of all coded segments).
* **IRR Analysis Tool:** A Python application to calculate Inter-Rater Reliability and generate dashboards.
...
- `ALIGN_SEGMENTS_ACROSS_CODES`:
    ...
    - `True`: Forces different codes on the same text to be aligned into a direct conflict.

---

## ⚖️ Licensing

* **Code:** All Python and HTML source code is licensed under the [GNU General Public License v3.0](LICENSE).
* **Data and Documentation:** The paper, interview template, codebook, diagrams, and README are licensed under the [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/) license.
